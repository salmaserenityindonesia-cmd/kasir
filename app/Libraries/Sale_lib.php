...
class Sale_lib
{
     ...
     * @return void
     */
    public function set_saldo_remainder(string $value): void
    {
        $this->session->set('sales_saldo_remainder', $value);
    }

    /**
     * @return string|null
     */
    public function get_saldo_remainder(): ?string
    {
        return $this->session->get('sales_saldo_remainder');
    }

    /**
     * @return void
     */
    public function clear_saldo_remainder(): void
    {
        $this->session->remove('sales_saldo_remainder');
    }
    ...
    public function clear_all(): void
    {
        ...
        $this->clear_rewards_remainder();
        $this->clear_saldo_remainder();
        $this->empty_payments();
        $this->remove_customer();
