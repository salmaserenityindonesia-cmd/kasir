...
return [
    ...
    "os_timezone"                               => "Fuso horário do kasir:",
    "kasir_info"                                => "Informações de instalação do kasir",
    ...
    "timezone_error"                            => "O fuso horário do kasir é diferente do fuso horário local.",
    "top"                                       => "Topo",
