...
return [
    ...
    "center"                                    => "Centro",
    "change_apperance_tooltip"                  => "Cambiar Aspecto de kasir",
    "comma"                                     => "coma",
    ...
    "kasir_info"                                => "Información de la Instalación kasir",
    ...
    "timezone_error"                            => "La zona horaria de kasir es diferente de tu zona horaria local.",
    "top"                                       => "Arriba",
    "use_destination_based_tax"                 => "Usar Impuesto Basado en Destino",
    "user_timezone"                             => "Zona Horaria kasir:",
    "website"                                   => "Sitio Web",
