...
return [
    ...
    "mass_bonus_amount"                         => "Nominal Penambahan Saldo Massal",
    "mass_bonus_amount_number"                  => "Nominal Penambahan Saldo Massal harus berupa angka.",
    "mass_bonus_amount_required"                => "Nominal Penambahan Saldo Massal harus diisi.",
    "message"                                   => "Pesan",
    ...
    "os_timezone"                               => "Zona waktu kasir:",
    "kasir_info"                                => "Info pemasangan kasir",
    ...
    "receipt_show_company_logo"                 => "Tampilkan logo perusahaan",
    "receipt_show_barcode"                      => "Tampilkan kode batang",
    ...
    "timezone"                                  => "Zona Waktu",
    "timezone_error"                            => "Zona Waktu kasir berbeda dari Zona Waktu Anda.",
    "top"                                       => "Atas",
