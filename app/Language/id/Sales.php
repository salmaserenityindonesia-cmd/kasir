...
return [
    ...
    "deposit_remaining_balance"        => "Saldo deposit yang tersisa adalah ",
    "account_number"                   => "Akun #",
    "add_payment"                      => "Terima",
    ...
    "customer_optional"                => "(Diperlukan untuk Pembayaran Pakai Saldo)",
    ...
    "remove_customer"                  => "Batalkan Pelanggan",
    "remove_discount"                  => "",
    "return"                           => "Retur",
