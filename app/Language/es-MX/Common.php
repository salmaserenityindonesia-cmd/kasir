...
return [
    ...
    "welcome_message"                => "Bienvenido(a) a kasir, haga clic en un módulo para comenzar.",
    "yes"                            => "Si",
    "you_are_using_kasir"            => "Está utilizando la versión de Código Abierto de Punto de Venta",
    "zip"                            => "CP",
];
