...
return [
    ...
    "os_timezone"                               => "Fuseau horaire d'kasir :",
    "kasir_info"                                => "Informations d'installation d'kasir",
    ...
    "timezone_error"                            => "Le fuseau horaire d'kasir est différent de votre fuseau horaire local.",
    "top"                                       => "Haut",
