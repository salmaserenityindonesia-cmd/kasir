...
return [
    ...
    "welcome_message"                => "Bine ați venit la kasir, faceți clic pe un modul de mai jos pentru a începe.",
    "yes"                            => "",
    "you_are_using_kasir"            => "Folosiți Open Source Point Of Sale versiunea",
    "zip"                            => "Cod poștal",
];
