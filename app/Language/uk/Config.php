...
return [
    ...
    "os_timezone"                               => "Часова зона kasir:",
    "kasir_info"                                => "Інформація про встановлення kasir",
    "payment_options_order"                     => "Варіанти оплати замовлення",
    "perm_risk"                                 => "Неправильні дозволи роблять kasir вразливим.",
    ...
    "timezone_error"                            => "Часовий пояс kasir відрізняється від вашого місцевого часового поясу.",
    "top"                                       => "Головний",
