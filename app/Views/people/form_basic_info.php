...
<div class="form-group form-group-sm">
    ...
    <div class="col-xs-8">
        <div class="input-group">
            <span class="input-group-addon input-sm" style="background: transparent; border-right: none;"><span class="material-symbols-rounded" style="font-size: 18px; color: var(--stitch-primary);">mail</span></span>
            <?= form_input([
                'name'  => 'email',
                'id'    => 'email',
                'class' => 'form-control input-sm',
...
<div class="form-group form-group-sm">
    ...
    <div class="col-xs-8">
        <div class="input-group">
            <span class="input-group-addon input-sm" style="background: transparent; border-right: none;"><span class="material-symbols-rounded" style="font-size: 18px; color: var(--stitch-primary);">call</span></span>
            <?= form_input([
                'name'  => 'phone_number',
                'id'    => 'phone_number',
                'class' => 'form-control input-sm',
