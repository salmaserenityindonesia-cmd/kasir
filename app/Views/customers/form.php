    ...
    <div class="tab-content">
        <div class="tab-pane fade in active" id="customer_basic_info">
            <fieldset>
                ...
                <div class="form-group form-group-sm">
                    <?= form_label(lang('Customers.nomorktp'), 'nomorktp', ['class' => 'control-label col-xs-3']) ?>
                    <div class="col-xs-4">
                        <?= form_input([
                            'name' => 'nomorktp',
                            'id' => 'nomorktp',
                            'class' => 'form-control input-sm',
                            'value' => $person_info->nomorktp
                        ]) ?>
                    </div>
                </div>
                ...
                <div class="form-group form-group-sm">
                    ...
                    <div class="col-xs-8">
                        <div class="input-group">
                            <span class="input-group-addon input-sm" style="background: transparent; border-right: none;"><span class="material-symbols-rounded" style="font-size: 18px; color: var(--stitch-primary);">calendar_month</span></span>
                            <?= form_input([
                                'name' => 'date',
                                'id' => 'datetime',
                                'class' => 'form-control input-sm',
