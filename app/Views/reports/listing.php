        ...
        <div class="panel panel-primary">
            ...
            <div class="list-group">
                ...
                <?php if (in_array('reports_sales', $permission_ids, true)) { ?>
                    <a class="list-group-item" href="<?= site_url('reports/detailed_saldo') ?>"><?= lang('Reports.detailed_saldo') ?></a>
                    <a class="list-group-item" href="<?= site_url('reports/detailed_sales_audit') ?>"><?= lang('Reports.detailed_sales_audit') ?? 'Audit Trail Penjualan' ?></a>
                <?php } ?>
            </div>
        </div>
