...
<div id="receipt_wrapper" style="font-size: <?= esc($config['receipt_font_size']) ?>px;">
    <div id="receipt_header">
        <?php if ($config['company_logo'] != '' && !empty($config['receipt_show_company_logo'])) { ?>
            <div id="company_name">
    ...
    <div id="receipt_general_info">
        <?php if (isset($customer_name)) { ?>
            <div id="customer"><?= lang('Customers.customer') . esc(": $customer_name") ?></div>
            <div id="saldo"><?= lang('Customers.saldo') . esc(": ") . to_currency($saldo) ?></div>
            <div id="nomorktp"><?= lang('Customers.nomorktp') . esc(": ") . esc($nomorktp) ?></div>
        <?php } ?>
    ...
    <table id="receipt_items">
        ...
        <tr>
            ...
            <td style="text-align: right;<?= $border ? ' border-top: 2px solid black;' : '' ?>">
                <?= to_currency($total) ?>
            </td>
        </tr>
    ...
    <?php if (!empty($config['receipt_show_barcode'])) { ?>
        <div id="barcode">
            <?= $barcode ?><br>
            <?= $sale_id ?>
        </div>
