...
<div class="stitch-card" style="border: none; box-shadow: none; padding: 0;">
    <div id="required_fields_message" style="margin-bottom: 20px; color: var(--stitch-text-secondary); font-size: 13px;">
        <span class="material-symbols-rounded" style="vertical-align: middle; font-size: 16px; color: #d93025;">info</span> <?= lang('Common.fields_required_message') ?>
    </div>
...
<?= form_open("items/save/$item_info->item_id", ['id' => 'item_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) ?>
    <fieldset id="item_basic_info">
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-xs-8">
                <div class="input-group">
                    <span class="input-group-addon input-sm" style="background: transparent; border-right: none;"><span class="material-symbols-rounded" style="font-size: 18px; color: var(--stitch-primary);">barcode</span></span>
                    <?= form_input([
                        'name'  => 'item_number',
                        'id'    => 'item_number',
        ...
        <div class="form-group form-group-sm">
            ...
            <div class="col-xs-8">
                <div class="input-group">
                    <span class="input-group-addon input-sm" style="background: transparent; border-right: none;"><span class="material-symbols-rounded" style="font-size: 18px; color: var(--stitch-primary);">label</span></span>
                    <?php
                    if ($config['category_dropdown']) {
                        echo form_dropdown('category', $categories, $selected_category, ['class' => 'form-control', 'style' => 'border-left: none;']);
                    } else {
                        echo form_input([
                            'name'  => 'category',
                            'id'    => 'category',
