...
<?= form_open('config/saveGeneral/', ['id' => 'general_config_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal']) ?>
    <div id="config_wrapper">
        <fieldset id="config_info">
            ...
            <div class="form-group form-group-sm">
                <?= form_label(lang('Config.mass_bonus_amount'), 'mass_bonus_amount', ['class' => 'control-label col-xs-2 required']) ?>
                <div class="col-xs-2">
                    <div class="input-group">
                        <span class="input-group-addon input-sm"><b><?= $config['currency_symbol'] ?></b></span>
                        <?= form_input([
                            'name'  => 'mass_bonus_amount',
                            'id'    => 'mass_bonus_amount',
                            'class' => 'form-control input-sm required',
                            'type'  => 'number',
                            'min'   => 0,
                            'step'  => 1000,
                            'value' => isset($config['mass_bonus_amount']) ? $config['mass_bonus_amount'] : 50000
                        ]) ?>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#general_config_form').validate($.extend(form_support.handler, {
            ...
            messages: {
                ...
                mass_bonus_amount: {
                    required: "<?= lang('Config.mass_bonus_amount_required') ?>",
                    number: "<?= lang('Config.mass_bonus_amount_number') ?>"
                },
                lines_per_page: {
