...
<?= form_open('config/saveReceipt/', ['id' => 'receipt_config_form', 'class' => 'form-horizontal']) ?>
    <div id="config_wrapper">
        <fieldset id="config_info">
            ...
            <div class="form-group form-group-sm">
                <?= form_label(lang('Config.receipt_show_company_logo'), 'receipt_show_company_logo', ['class' => 'control-label col-xs-2']) ?>
                <div class="col-xs-1">
                    <?= form_checkbox([
                        'name'    => 'receipt_show_company_logo',
                        'value'   => 'receipt_show_company_logo',
                        'id'      => 'receipt_show_company_logo',
                        'checked' => !empty($config['receipt_show_company_logo'])
                    ]) ?>
                </div>
            </div>

            <div class="form-group form-group-sm">
                <?= form_label(lang('Config.receipt_show_barcode'), 'receipt_show_barcode', ['class' => 'control-label col-xs-2']) ?>
                <div class="col-xs-1">
                    <?= form_checkbox([
                        'name'    => 'receipt_show_barcode',
                        'value'   => 'receipt_show_barcode',
                        'id'      => 'receipt_show_barcode',
                        'checked' => !empty($config['receipt_show_barcode'])
                    ]) ?>
                </div>
            </div>
