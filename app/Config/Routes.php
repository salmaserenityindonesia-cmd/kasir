...
$routes->add('reports/detailed_saldo', 'Reports::date_input_only');
$routes->add('reports/detailed_saldo/(:any)/(:any)', 'Reports::detailed_saldo/$1/$2');
$routes->add('reports/detailed_sales_audit', 'Reports::date_input_only');
$routes->add('reports/detailed_sales_audit/(:any)/(:any)', 'Reports::detailed_sales_audit/$1/$2');
