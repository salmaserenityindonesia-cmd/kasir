...
class Config extends Secure_Controller
{
    ...
    public function postSaveGeneral(): void
    {
        $batch_save_data = [
            ...
            'mass_bonus_amount'                 => $this->request->getPost('mass_bonus_amount', FILTER_SANITIZE_NUMBER_INT),
    ...
    public function postSaveReceipt(): void
    {
        $batch_save_data = [
            ...
            'receipt_show_company_logo'     => $this->request->getPost('receipt_show_company_logo') != null,
            'receipt_show_barcode'          => $this->request->getPost('receipt_show_barcode') != null,
